...
namespace EmpyrionScripting.CsHelper
{
    public partial class CsScriptFunctions
    {
        ...
        public Dictionary<int, double> ResourcesForBlockById(int id) => EmpyrionScripting.ConfigEcfAccess.ResourcesForBlockById.TryGetValue(id, out var recipe) ? recipe : null;
    }
}
